...
def init_colors():
    curses.start_color()
    curses.init_pair(1, curses.COLOR_BLACK, curses.COLOR_WHITE) # White
    curses.init_pair(2, curses.COLOR_WHITE, curses.COLOR_BLACK) # Blue
    ...
    curses.init_pair(8, curses.COLOR_MAGENTA, curses.COLOR_BLACK)# Magenta
